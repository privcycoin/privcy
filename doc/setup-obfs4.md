...
#### Activate obfs4 functionality in PrivcyCoin.conf

Open your *PrivcyCoin.conf* and add those two lines:
...
* Windows - %APPDATA%/Roaming/PrivcyCoin/tor

This is the path under Windows.

![win-torrc-path](https://img2.picload.org/image/ddpcagra/torrc_path.png)

* Linux - ~/.PrivcyCoin/tor
* Mac -  ~/Library/Application Support/PrivcyCoin/tor
...
As Windows has no default Package Manager there are several ways to get **obfs4proxy.exe**. One could simply install the Tor-Browser manually and put the provided **obfs4proxy.exe** into the directory of your PrivcyCoin installation. 
