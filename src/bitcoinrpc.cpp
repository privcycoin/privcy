...
{
    return GetBoolArg("-testnet", false) ? 28780 : 18780;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop PRiVCY server (and possibly override the detachdb config value).");
    // Shutdown will take long enough that the response should get back
    if (params.size() > 0)
        bitdb.SetDetach(params[0].get_bool());
    StartShutdown();
    return "PRiVCY server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"wallet",			  "setchangeaddress",	    &setchangeaddress,	 	 true,   false},
		{"wallet", 			  "getchangeaddress", 		&getchangeaddress, 		 true,   false},
        ...
        {"wallet",			  "deleteaddress",          &deleteaddress,          false,  false},
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use PRiVCYd";
