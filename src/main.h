...
static const int SWITCH_BLOCK_HARD_FORK = 10;
static const int SWITCH_BLOCK_HARD_FORK_TESTNET = 10;
static const int SWITCH_BLOCK_HARD_FORK_TESTNET_NARRATION_FIX = 10;
...
static const uint256 hashGenesisBlock("0x000002c7e5f524ec8dcb7f45fb048080530da558c2e5bcbbedf34afc18fb7820");
static const uint256 hashGenesisBlockTestNet("0x000009adff5bcded4028f4f314adea4064bc1bbde0f92ba981d89e4255e7c772");
...
public:
    ...
    {
        // Privcy: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Privcy: get transaction coin age
...
public:
  ...
  // Privcy: block signature - signed by one of the coin base txout[N]'s owner
  ...
  bool DoS(int nDoSIn, bool fIn) const
  {
    ...
    // Privcy: two types of block: proof-of-work or proof-of-stake
    ...
    // Privcy: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Privcy: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // Privcy: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Privcy: block index flags
    enum  
    {
