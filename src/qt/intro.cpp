...
{
    ui->setupUi(this);
    ui->storageLabel->setText(ui->storageLabel->text().arg(tr("PRiVCY")));
    ...
    ui->lblExplanation2->setText(ui->lblExplanation2->text().arg(tr("PRiVCY")));
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || settings.value("fReset", false).toBool() || GetBoolArg("-resetguisettings", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PRiVCY"),
