...
TransactionTableModel::TransactionTableModel(CWallet* wallet, WalletModel *parent):
        ...
        cachedNumBlocks(0)
{
	columns << QString() << tr("Date") << tr("Type") << tr("Address") << tr("Memo") << tr("Amount");
...
QString TransactionTableModel::formatMemo(const TransactionRecord *wtx) const
{
