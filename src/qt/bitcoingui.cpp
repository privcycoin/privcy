...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PRiVCY address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PRiVCY"), this);
    aboutAction->setToolTip(tr("Show information about PRiVCY"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (clientModel->isTestNet())
        {
            ...
            if (trayIcon)
            {
                trayIcon->setToolTip(tr("PRiVCY client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PRiVCY client"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if (event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PRiVCY address or malformed URI parameters."));
    }
