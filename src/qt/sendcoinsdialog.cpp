    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a PRiVCY address"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            QMessageBox::Ok, QMessageBox::Ok);
        break;
    case WalletModel::MemoTooLong:
    	QMessageBox::warning(this, tr("Send Coins"),
    		tr("Error: Memo is too long! Only 24 characters allowed."),
			QMessageBox::Ok, QMessageBox::Ok);
    	break;
