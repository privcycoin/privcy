...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. PRiVCY can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("PRiVCY");
    //XXX app.setOrganizationDomain("");
    bool isTestNet = false;
    if(GetBoolArg("-testnet")) { // Separate UI settings for testnet
        app.setApplicationName("PRiVCY-Qt-testnet");
        isTestNet = true;
    }
    else
        app.setApplicationName("PRiVCY-Qt");
